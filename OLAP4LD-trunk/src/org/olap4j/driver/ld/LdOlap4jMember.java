    ...
    implements XmlaOlap4jMemberBase, Member, Named
{
    ...
    */
    ...
    private LdOlap4jMember parentMember;
    ...
    public boolean equals(Object obj) {
        return obj instanceof LdOlap4jMember
            && ((LdOlap4jMember) obj).uniqueName.equals(uniqueName);
    }

    public NamedList<? extends Member> getChildMembers() throws OlapException {
        final NamedList<LdOlap4jMember> list =
            new NamedListImpl<LdOlap4jMember>();
        getCube()
            .getMetadataReader()
    ...
    public LdOlap4jMember getParentMember() {
    ...
    public LdOlap4jLevel getLevel() {
        return olap4jLevel;
    }

    public LdOlap4jHierarchy getHierarchy() {
        return olap4jLevel.olap4jHierarchy;
    }

    public LdOlap4jDimension getDimension() {
    ...
    public List<Member> getAncestorMembers() {
        ...
        LdOlap4jMember m = getParentMember();
        while (m != null) {
            list.add(m);
            m = m.getParentMember();
        }
    ...
    public LdOlap4jCube getCube() {
        return olap4jLevel.olap4jHierarchy.olap4jDimension.olap4jCube;
    }

    // convenience method - not part of olap4j API
    public LdOlap4jCatalog getCatalog() {
        return olap4jLevel.olap4jHierarchy.olap4jDimension.olap4jCube
            .olap4jSchema.olap4jCatalog;
    }

    // convenience method - not part of olap4j API
    public LdOlap4jConnection getConnection() {
        return olap4jLevel.olap4jHierarchy.olap4jDimension.olap4jCube
