...
import org.olap4j.driver.ld.XmlaOlap4jServerInfos;
import org.olap4j.driver.ld.proxy.XmlaOlap4jAbstractHttpProxy;
...
{
    private final LdOlap4jDriver driver;
    ...
    {
        return LdOlap4jDriver.getFuture(this, serverInfos, request);
    }
