...
abstract class XmlaOlap4jPreparedStatement
    extends LdOlap4jStatement
    implements PreparedOlapStatement, OlapParameterMetaData
{
    final LdOlap4jCellSetMetaData cellSetMetaData;
        ...
        String mdx) throws OlapException
    {
        ...
        try {
            ...
            final LdOlap4jCellSetMetaData cellSetMetaData1 =
                (LdOlap4jCellSetMetaData) cellSet.getMetaData();
