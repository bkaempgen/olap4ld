 ...
 *
 * @author jhyde
 * @version $Id: XmlaOlap4jPositionMember.java 374 2010-12-03 02:29:37Z jhyde $
 * @since Dec 7, 2007
 */
class Olap4ldPositionMember
    implements Olap4ldMemberBase
{
    private final Olap4ldMemberBase member;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Olap4ldPositionMember) {
            Olap4ldPositionMember that =
                (Olap4ldPositionMember) obj;
            return this.member.equals(that.member);
        } else if (obj instanceof Olap4ldMember) {
            Olap4ldMember that = (Olap4ldMember) obj;
    ...
    public int getDepth() {
        try {
            final Object value =
                Olap4ldMember.getPropertyValue(
                    Property.StandardMemberProperty.DEPTH,
                    member,
                    getPropertyValueMap());
            return Olap4ldMember.toInteger(value);
