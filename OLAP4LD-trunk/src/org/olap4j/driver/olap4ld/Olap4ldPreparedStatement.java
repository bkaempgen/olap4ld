 ...
 *
 * @author jhyde
 * @version $Id: XmlaOlap4jPreparedStatement.java 404 2011-03-18 21:54:56Z lucboudreau $
 * @since Jun 12, 2007
 */
abstract class Olap4ldPreparedStatement
    extends Olap4ldStatement
    implements PreparedOlapStatement, OlapParameterMetaData
{
    final Olap4ldCellSetMetaData cellSetMetaData;
...
//        }
     ...
     */
    private final LdHelper getHelper() {
    ...
    public String getParameterClassName(int param) throws SQLException {
        final Type type = getParameterOlapType(param);
        return foo(
            new Olap4ldPreparedStatement.TypeHelper<Class<?>>() {
    ...
    <T> T foo(Olap4ldPreparedStatement.TypeHelper<T> helper, Type type) {
