...
public class ReturnMetadataTest extends TestCase {
	...
	public ReturnMetadataTest() throws SQLException {
	}
	...
	public void testDatabaseMetaDataGetMembers() throws SQLException {
		String s = checkResultSet(olapDatabaseMetaData.getMembers(catalogName,
				null, null, null, null, null, null, null), MEMBERS_COLUMN_NAMES);
		// String s =
		// checkResultSet(olapDatabaseMetaData.getMembers(catalogName,
		// "FoodMart", "Sales", null, "[Gender]", null, null, null),
	...
	private String checkResultSet(ResultSet resultSet, List<String> columnNames)
		...
		/* 
		 * Visualize. We do not need visualization, since we already have gone through all result
		 * sets with next() and can return them at the end.
		 */
		// try {
