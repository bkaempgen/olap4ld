...
public class SSBMetadataTest extends TestCase {
	...
	public void testDatabaseMetaDataGetHierarchies() throws SQLException {
		...
		assertContains(
				"CATALOG_NAME="
						+ catalogName
						+ ", SCHEMA_NAME=LdSchema, CUBE_NAME=rdfh-inst:dsd, DIMENSION_UNIQUE_NAME=rdfh:lo_custkey, HIERARCHY_NAME=rdfh:lo_custkeyCodeList, HIERARCHY_UNIQUE_NAME=rdfh:lo_custkeyCodeList, HIERARCHY_GUID=, HIERARCHY_CAPTION=rdfh:lo_custkeyCodeList, DIMENSION_TYPE=, HIERARCHY_CARDINALITY=, DEFAULT_MEMBER=, ALL_MEMBER=, DESCRIPTION=rdfh:lo_custkeyCodeList, STRUCTURE=, IS_VIRTUAL=, IS_READWRITE=, DIMENSION_UNIQUE_SETTINGS=, DIMENSION_IS_VISIBLE=, HIERARCHY_IS_VISIBLE=, HIERARCHY_ORDINAL=, DIMENSION_IS_SHARED=, PARENT_CHILD=",
				s);
		...
		assertContains(
				"CATALOG_NAME="
						+ catalogName
						+ ", SCHEMA_NAME=LdSchema, CUBE_NAME=rdfh-inst:dsd, DIMENSION_UNIQUE_NAME=rdfh:lo_quantity, HIERARCHY_NAME=rdfh:lo_quantity, HIERARCHY_UNIQUE_NAME=rdfh:lo_quantity, HIERARCHY_GUID=, HIERARCHY_CAPTION=rdfh:lo_quantity, DIMENSION_TYPE=, HIERARCHY_CARDINALITY=, DEFAULT_MEMBER=, ALL_MEMBER=, DESCRIPTION=rdfh:lo_quantity, STRUCTURE=, IS_VIRTUAL=, IS_READWRITE=, DIMENSION_UNIQUE_SETTINGS=, DIMENSION_IS_VISIBLE=, HIERARCHY_IS_VISIBLE=, HIERARCHY_ORDINAL=, DIMENSION_IS_SHARED=, PARENT_CHILD=",
				s);
		...
		TestContext
				.assertEqualsVerbose(
						"CATALOG_NAME="
								+ catalogName
								+ ", SCHEMA_NAME=LdSchema, CUBE_NAME=rdfh-inst:dsd, DIMENSION_UNIQUE_NAME=rdfh:lo_orderdate, HIERARCHY_NAME=rdfh:lo_orderdateCodeList, HIERARCHY_UNIQUE_NAME=rdfh:lo_orderdateCodeList, HIERARCHY_GUID=, HIERARCHY_CAPTION=rdfh:lo_orderdateCodeList, DIMENSION_TYPE=, HIERARCHY_CARDINALITY=, DEFAULT_MEMBER=, ALL_MEMBER=, DESCRIPTION=rdfh:lo_orderdateCodeList, STRUCTURE=, IS_VIRTUAL=, IS_READWRITE=, DIMENSION_UNIQUE_SETTINGS=, DIMENSION_IS_VISIBLE=, HIERARCHY_IS_VISIBLE=, HIERARCHY_ORDINAL=, DIMENSION_IS_SHARED=, PARENT_CHILD=\n",
						s);
